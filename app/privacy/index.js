...
class PrivacyIndex extends React.Component<Props> {
  render() {
    return (
      <div className="privacy-policy ant-margin-large-top ant-margin-large-bottom">
        <Container>
          ...
          <p>
            {
              'This Privacy Policy describes how your personal information is collected, used, and shared when you visit https://www.travelingmaude.com/ (hereinafter referred to as the "Service").'
            }
          </p>
          ...
          <p>
            ...
            meanings as in our Terms and Conditions, accessible from https://www.travelingmaude.com/
          </p>
          ...
          <ul>
            <li>
              ...
              <p>
                Service is the https://www.travelingmaude.com/ website operated by Traveling Maude
              </p>
            </li>
            <li>
              <p>
...
We use Security Cookies for security purposes.
          ...
          <p>Traveling Maude uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            Traveling Maude will take all steps reasonably necessary to ensure that your data is
          ...
          <p>
            Traveling Maude may disclose your Personal Data in the good faith belief that such
            action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Traveling Maude</li>
          ...
          <ul>
            <li>
              ...
              <p>
                Google Analytics is a web analytics service. Read the Privacy Policy for Google
                Analytics here:
...
.
          ...
          <ul>
            <li>By email: info@travelingmaude.com</li>
          </ul>
        </Container>
      </div>
    );
